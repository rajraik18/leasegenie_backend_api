...
def pytest_configure(config):
    ...
    # Very high rate limits in tests so the slowapi limiter never trips
    # across the suite (it shares state across tests).
    os.environ.setdefault("RATE_LIMIT_DEFAULT", "100000/minute")
    os.environ.setdefault("RATE_LIMIT_EXTRACT", "100000/hour")
